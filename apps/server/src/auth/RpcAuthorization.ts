...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.computerUseTakeOver]: AuthComputerOperateScope,
  [WS_METHODS.computerUsePause]: AuthComputerOperateScope,
  [WS_METHODS.computerUseResume]: AuthComputerOperateScope,
