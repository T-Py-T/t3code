...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.computerUseGetControlState]: AuthOrchestrationReadScope,
  [WS_METHODS.computerUseRevokePersistentGrant]: AuthOrchestrationOperateScope,
  [WS_METHODS.computerUseStop]: AuthOrchestrationOperateScope,
