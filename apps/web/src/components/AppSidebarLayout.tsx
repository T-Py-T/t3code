...
import { useEnvironmentIdentificationMode, useSidebarNavigationMode } from "../hooks/useSettings";
  ...
  return (
    <SidebarProvider className="h-dvh! min-h-0!" defaultOpen style={sidebarProviderStyle}>
      ...
      >
        ...
        ) : sidebarNavigationMode !== "cards" ? (
          <LegacyThreadSidebar
            groupByEnvironment={sidebarNavigationMode === "environment-project-tree"}
          />
        ) : (
          <ThreadSidebar />
        )}
